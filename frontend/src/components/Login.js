...
export const LoginPage = () => {
  ...
  }, []); // The empty array [] means this runs exactly ONCE when the page first appears

  // State to hold the manual email/password typing and loading UI
  ...
  // ==========================================
  // 1. THE HELPER: Talks to your Backend (The Bridge)
  // ==========================================
  // This function takes the secure token generated by Firebase and sends it to your MongoDB backend
